...
namespace FreeKingdomLit.Migrations
{
    ...
    [Migration("20230821223536_addBookAuth")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FreeKingdomLit.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("FreeKingdomLit.Models.Book", b =>
                {
                    b.HasOne("FreeKingdomLit.Models.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("FreeKingdomLit.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
